...
type userWithoutPassWord = Pick< user & { id: string; }, Exclude<keyof user & { id: string; }, 'password'> >
...
export class UserModelService {
	...
	public async createUser(newUser: newUserDTO): Promise<userWithoutPassWord> {
